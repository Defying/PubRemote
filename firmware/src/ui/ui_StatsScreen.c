...
ui_PrimaryDial = lv_arc_create(ui_StatsScreen);
lv_obj_set_width( ui_PrimaryDial, lv_pct(100));
lv_obj_set_height( ui_PrimaryDial, lv_pct(100));
lv_obj_set_align( ui_PrimaryDial, LV_ALIGN_CENTER );
lv_arc_set_range(ui_PrimaryDial, 0,40);
lv_arc_set_value(ui_PrimaryDial, 0);
...
lv_obj_set_style_pad_right(ui_SecondaryDial, 20, LV_PART_MAIN| LV_STATE_DEFAULT);
lv_obj_set_style_pad_top(ui_SecondaryDial, 20, LV_PART_MAIN| LV_STATE_DEFAULT);
lv_obj_set_style_pad_bottom(ui_SecondaryDial, 20, LV_PART_MAIN| LV_STATE_DEFAULT);
